        ...
        <div className="container mt-5">
            ...
            <div className="card product-details-card">
                ...
                <div className="card-body">
                    ...
                    <p><strong>Date Added:</strong> {gift.date_added ? new Date(gift.date_added * 1000).toLocaleDateString() : gift.dateAdded}</p>
                    <p><strong>Age (Years):</strong> {gift.age_years || gift.age}</p>
