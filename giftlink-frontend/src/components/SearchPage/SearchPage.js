        ...
        <div className="container mt-5">
            <div className="row justify-content-center">
                <div className="col-md-6">
                    ...
                    {/* Added id="search-button" */}
                    <button id="search-button" className="btn btn-primary w-100" onClick={handleSearch}>Search</button>
                    
                    <div className="search-results mt-4">
                        {searchResults.length > 0 ? (
                            searchResults.map(product => (
                                <div key={product._id || product.id} className="card mb-3">
                                    ...
                                    <div className="card-footer">
                                        <button 
                                            onClick={() => goToDetailsPage(product._id || product.id)} 
